...
import { PerformanceLevel }  from './enums';
...
export class PerformanceManager {
    ...
    private _targetLevel: PerformanceLevel = PerformanceLevel.HIGH_PERFORMANCE;
    ...
    protected onInit (): void {
        ...
        this._inspectorClient = new InspectorClient('192.168.52.139', 3011);
        this._inspectorClient?.connect();
    }
    ...
    set runningLevel (level: PerformanceLevel) {
